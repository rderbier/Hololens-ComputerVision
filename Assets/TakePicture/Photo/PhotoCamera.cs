...
public class PhotoCamera : MonoBehaviour
{
    ...
    public string debugTopic = "debug";
    ...
    void Start()
    {
        ...
        if ((PhotoCapture.SupportedResolutions != null) && (PhotoCapture.SupportedResolutions.Count() > 0))
        {
            ...
            Log("Resolution " + cameraResolution.width + " x " + cameraResolution.height);
        }
        else
        {
            ratio = 9f / 16f;
        ...
        Log("scanContext init " + scanContext.ToString());
        ...
        PhotoCapture.CreateAsync(false, delegate (PhotoCapture captureObject)
        {
            ...
            {
                // Take a picture
                Log("camera ready to take picture");
    ...
    {
        Log("start Scanner for picture creation");
        gazeStarted = false;
        startPicture = true;
    }
    ...
    private IEnumerator TakePictureInternal()
    {
        ...
        {
            Log("camera object is not defined");
        }
        yield return null;
    }
    ...
    private byte[] ConvertAndShowOnDebugPane(PhotoCaptureFrame photoCaptureFrame)
    {
        ...
        try
        {
            ...
            // Hololens images taken always a bit too high 
            int pixcorrection = 0;
            if (cameraResolution.width > 3000) { 
                pixcorrection = -180;
            }
            ...
            int y = ((cameraResolution.height - dy) / 2) + pixcorrection;

            Log("Image area: " + x + "|" + y + "|" + dx + "|" + dy);
    ...
    public void Log(String str)
    {
        ...
        //remote Debug, using MQTT
        mqttHelper.Publish(debugTopic, str);
    }
